...
<script type="text/javascript">
	...
	function goUserReservationSituation(){
		document.ReservationSituationMain.submit();
	}
				...
				<div class="nav">  
					...
					<li class="navi_set">  
						...
						<ul class="subnav">  
							...
							<li><a href="javascript:goUserReservationSituation();">신청현황</a></li> 
...
<form name="ReservationSituationMain" method="post" action="/support/userReservationSituation.do">
</form>
