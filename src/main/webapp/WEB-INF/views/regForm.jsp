...
<script>
	...
	function acceptEmail(type){
		...
		$.ajax({
			...
			type:"post",
			data: $("[name="+type+"RegForm] [name=email]").serialize(),
			datatype:"html",
	...
	function checkAuthenticationNumber(type){
		...
		var authenticationNumber = $("[name="+type+"RegForm] [name=AuthenticationNumber]").val();
						...
						<div class="form-row m-b-55">
							...
							<div class="wrap-input40 input-group-desc">
								<input type="button"
									...
									name="userRegFormBtn" onclick="changeToUser();" value="일반회원">
							...
							<div class="wrap-input40 input-group-desc">
								...
								<input type="button"
									class="login100-form-btn btn btn--radius-2 btn--blue"
									name="driverRegFormBtn" onclick="changeToDriver();" value="운전자">
								<span class="focus-input100"></span>
					...
					<form name="userRegForm" method="POST">
							...
							<div class="value">
								<div class="row row-space">
									<div class="input-group wrap-input100">
										...
										<input class="input100 input--style-5" type="text" name="name"
						...
						<div class="form-row m-b-55">
							...
							<div class="wrap-input40 input-group-desc">
								...
								<input type="button"
									class=" login100-form-btn btn btn--radius-2 btn--red"
									onclick="goUserRegForm();" value="가입"> <span
									class="focus-input100"></span>
							...
							<div class="wrap-input40 input-group-desc">
								...
								<input type="button"
									...
									type="button" onclick="goLoginForm();" value="취소"> <span
									class="focus-input100"></span>
